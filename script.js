...
fruits.splice(2 , 1, "strawberry" ,"pineapple" )
console.log(fruits)
...
// "cherry" and "date".
var fruits1 = ["apple", "banana", "cherry", "date", "fig"]
 var foods = fruits1.slice(1 , 0 ,1)
